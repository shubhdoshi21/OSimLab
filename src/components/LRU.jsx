...
const LRU = ({ memoryReferences, memorySize }) => {
  ...
  const handleNextPageClick = () => {
    if (pageNumber < memoryReferences.length) {
      ...
      newColumnData[currentColumn] = memoryReferences
        .map((reference, index) => (index <= displayedIndex ? reference.size : '')); // Update the current column data
